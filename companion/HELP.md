...
| Common | Batch Kill All Bus Sends | Disable all 16 bus sends from a channel or aux. |
...
| Common | Reset Channel | Full reset: cut fader, unmute, zero trim/pan/width/phase-invert, bus and main sends to unity, EQ flat. |
